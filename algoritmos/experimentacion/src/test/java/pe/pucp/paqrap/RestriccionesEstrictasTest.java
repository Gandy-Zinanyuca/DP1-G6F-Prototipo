...
public final class RestriccionesEstrictasTest {
 ...
 static ALNSPlanner alns() {return new ALNSPlanner(new ConfiguracionALNS(6,6,3,2,.7,.05,0,7));}
 public static void main(String[] args) {
  ...
  testComparabilidad();testValidacionEntrada();
 ...
 static void testComparabilidad(){
  ...
  ok(ts.metricas().candidatosEvaluados()>0&&al.metricas().candidatosEvaluados()>0,"sin candidatos");pruebas++;
 }
