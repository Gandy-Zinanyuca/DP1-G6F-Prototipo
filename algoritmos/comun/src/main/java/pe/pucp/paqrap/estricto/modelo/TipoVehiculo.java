...
public enum TipoVehiculo {
    ...
    TipoVehiculo(String descripcion, int capacidad, int velocidadKmh, int costoPorKm) {
        this.descripcion = descripcion; this.capacidad = capacidad;
        this.velocidadKmh = velocidadKmh; this.costoPorKm = costoPorKm;
    }
    public String descripcion() { return descripcion; }
    public int capacidad() { return capacidad; }
    public int velocidadKmh() { return velocidadKmh; }
    public int costoPorKm() { return costoPorKm; }
