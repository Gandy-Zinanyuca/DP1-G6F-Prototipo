...
public record PartePedido(String id, Pedido pedido, int cantidad) {
 public PartePedido { Objects.requireNonNull(id); Objects.requireNonNull(pedido); if(id.isBlank() || cantidad<=0 || cantidad>pedido.cantidad()) throw new IllegalArgumentException("Parte invalida"); }
}
