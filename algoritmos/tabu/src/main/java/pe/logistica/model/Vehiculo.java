...
public record Vehiculo(String codigo, TipoVehiculo tipo, Nodo ubicacionInicial,
                       boolean disponible, LocalDateTime disponibleDesde) {
    public Vehiculo {
        Objects.requireNonNull(tipo); Objects.requireNonNull(ubicacionInicial); Objects.requireNonNull(disponibleDesde);
