 ...
 *
 * <p>
 * Capacidades, velocidades y costos provienen del enunciado de la situación
 * auténtica: auto 24 paquetes / 40 km-h / S/ 8.00 por km; moto 8 / 25 / S/
 * 6.00; bicicleta 4 / 12 / S/ 3.00. Los valores son mutables mediante
 * {@link #setVelocidadKmH(double)} para satisfacer LE024 (velocidad promedio
 * configurable por parámetro sin recompilar).
 * </p>
 *
 * <p>
 * El prefijo de código corresponde a la nomenclatura de los archivos de
 * mantenimiento preventivo: TA = auto, TM = moto, TB = bicicleta.
 * </p>
 */
public enum TipoVehiculo {

    AUTO("TA", 24, 40.0, 8.00), MOTO("TM", 8, 25.0, 6.00), BICICLETA("TB", 4, 12.0, 3.00);
    ...
    /**
     * Minutos necesarios para recorrer {@code km} kilómetros a la velocidad del
     * tipo.
     */
    ...
    /**
     * Resuelve el tipo a partir del prefijo del código de unidad (TA01, TM07,
     * TB11).
     */
