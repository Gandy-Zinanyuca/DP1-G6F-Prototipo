 ...
 *
 * <p>El reloj de la simulación se expresa en minutos enteros desde el día 01 a las 00:00.
 * Los cambios de turno ocurren a las 07:00, 15:00 y 23:00 (LE017, LE069) y cada unidad debe
 * reservar una hora de alimentación dentro de su jornada, ubicada al menos una hora antes o
 * una hora después de un cambio de turno (LE018).</p>
 *
 * <p>Como consecuencia de esa regla, la hora de alimentación de un turno solo puede empezar
 * dentro de la ventana [inicioTurno + 60, inicioTurno + 8h - 120] minutos: comenzar antes
 * dejaría menos de una hora de separación con el cambio de turno que abre la jornada, y
 * terminar después dejaría menos de una hora de separación con el cambio que la cierra.</p>
 */
public final class Turnos {
    ...
    /**
     * Índice del turno (0, 1 o 2) vigente en el minuto indicado. El turno 2 (23:00-07:00)
     * cruza la medianoche, por lo que las horas anteriores al primer cambio pertenecen a él.
     */
    ...
    /** Primer minuto en que la unidad puede iniciar su hora de alimentación en ese turno. */
    ...
    /** Último minuto en que la unidad puede iniciar su hora de alimentación en ese turno. */
    ...
    public static boolean alimentacionValida(int inicio) {
        return inicio >= inicioVentanaAlimentacion(inicio)
                && inicio <= finVentanaAlimentacion(inicio);
    }

    /** Representación legible "DDdHHhMMm" coherente con el formato de los archivos de entrada. */
