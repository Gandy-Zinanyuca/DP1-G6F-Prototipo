 ...
 *
 * <p>
 * Los archivos del curso siguen una nomenclatura por periodo:
 * {@code ventas.AAAAMM.txt} y {@code bloqueo.AAMM.txt}. A partir de las
 * carpetas donde están, el simulador encuentra el archivo del mes siguiente
 * cuando necesita encadenarlo.
 * </p>
 */
public class FuentesDeDatos {
     ...
     * @param carpetaBloqueos carpeta de los archivos {@code bloqueo.AAMM.txt}, o
     *                        {@code null} para simular sin bloqueos
     */
    ...
    public Path ventas(YearMonth mes) {
        Path p = carpetaVentas.resolve(String.format("ventas.%04d%02d.txt", mes.getYear(), mes.getMonthValue()));
    ...
    public Path bloqueos(YearMonth mes) {
        ...
        Path p = carpetaBloqueos
                .resolve(String.format("bloqueo.%02d%02d.txt", mes.getYear() % 100, mes.getMonthValue()));
        return Files.exists(p) ? p : null;
    }
}
