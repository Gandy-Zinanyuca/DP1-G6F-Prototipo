...
/**
 * Parámetros del avance temporal de la simulación, independientes del
 * algoritmo.
 */
public class ParametrosSimulacion {
    ...
    /**
     * Número máximo de ciclos de planificación; 0 significa sin límite, que es el
     * modo "hasta el colapso": la simulación sigue, encadenando meses, hasta que
     * colapsa o se acaban los datos.
     */
    public int maxCiclos = 0;

    /**
     * Imprime una línea por ciclo (y el resumen del planificador) en lugar de una
     * por día.
     */
    ...
    /**
     * Archivo CSV al que se agrega una fila con el resumen de la corrida, o
     * {@code null}.
     */
